function [net, info] = cnn_train_b1(net, imdb, getBatch, varargin)
...
if isstr(opts.errorFunction)
  switch opts.errorFunction
    ...
    case 'multiclass'
      ...
      if isempty(opts.errorLabels), opts.errorLabels = {'top1e', 'top3e'} ; end
    case 'binary'
...
err(2,1) = sum(sum(sum(mass .* min(error(:,:,1:3,:),[],3)))) ;
