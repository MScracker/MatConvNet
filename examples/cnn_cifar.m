...
opts.expDir = fullfile(root,'..','data', sprintf('cifar-10-%s', opts.modelType)) ;
[opts, varargin] = vl_argparse(opts, varargin) ;

opts.train.numEpochs = numel(opts.train.learningRate) ;
[opts, varargin] = vl_argparse(opts, varargin) ;

opts.dataDir = fullfile(root,'..','data','cifar-10') ;
opts.imdbPath = fullfile(opts.dataDir, 'cifar-10-imdb.mat');
opts.useBnorm = true ;
